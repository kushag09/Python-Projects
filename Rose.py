...
def wishMe():
    ...
    speak('I am Rose, your assistant, please tell me how may I help you')
    ...
    if 'rose' in start:
            ...
            while True:
                ...
                if 'who is' in query:
                    ...
                    speak('I am Rose and I am your assistant')
                    ...
                    my_lang = translator.detect(trans_word)
                    ...
                    try:
                        ...
                        lang1 = my_lang.lang
                        engine.setProperty('languages', lang1)
                    ...
                    if len(times) == 4:
                        hour = int(times[:2])
                        minutes = int(times[2:])
                        speak(f'Setting the alarm at {hour} {minutes} for {rson}')
                        while True:
                            if datetime.datetime.now().hour == hour and datetime.datetime.now().minute == minutes:
                                speak(f'Please be ready for {rson}')
                                break

                    elif len(times) == 2:
                        hour = times
                        minutes = '00'
                        speak(f'Setting the alarm at {hour} zero zero for {rson}')
                        while True:
                            if datetime.datetime.now().hour == hour and str(datetime.datetime.now().minute) == minutes:
                                speak(f'Please be ready for {rson}')
                                break
                    else:
                        speak('Please tell me a valid time')
